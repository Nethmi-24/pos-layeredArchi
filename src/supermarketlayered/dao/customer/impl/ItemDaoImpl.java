...
public class ItemDaoImpl implements ItemDao {
    ...
    public boolean update(ItemEntity t) throws Exception {
        return CrudUtil.executeUpdate("UPDATE item SET description=?, packSize=?, unitPrice=?, qoh=? WHERE  itemCode=?", t.getDescription(), t.getPackSize(), t.getUnitPrice(), t.getQty(), t.getId());
    }
